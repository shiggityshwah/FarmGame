 ...
 *
 * Layout (tileX=23, tileY=39):
 *   (23,39) (24,39)  — top row: tiles 1256, 1257. Visual only, rendered ABOVE characters.
 *                       These tiles do NOT block movement or tool actions.
 *   (23,40) (24,40)  — middle row: tiles 1320, 1321. Blocks movement + actions.
 *   (23,41) (24,41)  — bottom row: tiles 1384, 1385. Blocks movement + actions.
 *
 * Rendering:
...
export class Well {
    constructor(tilemap) {
        ...
        // Top-left corner of the well (top row): x=23, y=39 (1 left, 1 down from original)
        this.tileX = 23;
        this.tileY = 39;
