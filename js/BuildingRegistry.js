...
export const BUILDING_DEFS = {
    ...
    // ── Debug-only test buildings (use existing tilemaps for layout testing) ──
    debug_home: {
        id: 'debug_home',
        name: 'Debug Home (10×10)',
        category: 'house',
        tilemapPrefix: 'Tileset/home',
        footprint: { width: 10, height: 10 },
        layers: [
            { csvSuffix: '_Ground.csv',             renderPass: 'ground' },
            { csvSuffix: '_Decor.csv',              renderPass: 'ground' },
            { csvSuffix: '_Buildings (Base).csv',   renderPass: 'ground' },
            { csvSuffix: '_Buildings (Detail).csv', renderPass: 'ground' },
    ...
    // ── Special buildings (unlocked by villagers; use home.tmx tileset) ─────────
    // All special buildings share the home.tmx layout: 10×10 footprint,
    // same layer names, door at local offset (2, 8).
    pub: {
        id: 'pub', name: 'Pub / Inn', category: 'special',
        tilemapPrefix: 'Tileset/home', footprint: { width: 10, height: 10 },
        layers: [
            { csvSuffix: '_Ground.csv',            renderPass: 'ground' },
            { csvSuffix: '_Decor.csv',             renderPass: 'ground' },
            { csvSuffix: '_Buildings (Base).csv',  renderPass: 'ground' },
        ...
        constructionCycles: 10, doorOffset: { x: 2, y: 8 },
    ...
    workshop: {
        ...
        constructionCycles: 12, doorOffset: { x: 2, y: 8 },
    ...
    shrine_temple: {
        ...
        constructionCycles: 14, doorOffset: { x: 2, y: 8 },
    ...
    stable: {
        ...
        constructionCycles: 16, doorOffset: { x: 2, y: 8 },
    ...
    town_hall: {
        ...
        constructionCycles: 20, doorOffset: { x: 2, y: 8 },
